  ...
  <div class="system">
    ...
    >
      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item
          title="v2ray-manager配置"
          name="v2ray-manager"
        >
          <el-form-item label="host">
            <el-input v-model="config['v2ray-manager']['host']" />
          </el-form-item>
          <el-form-item label="port">
            <el-input v-model.number="config['v2ray-manager']['port']" />
          </el-form-item>
          <el-form-item label="默认alterId">
            <el-input v-model.number="config['v2ray-manager']['defaultAlterId']" />
          </el-form-item>
          <el-form-item label="默认level">
            <el-input v-model.number="config['v2ray-manager']['defaultLevel']" />
          </el-form-item>
          <el-form-item label="secret加密Key(用于密文保存到数据库)">
            <el-input v-model="config['v2ray-manager']['secretKey']" />
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item
          title="vpsproxy配置"
        ...
        >
          <el-form-item label="port">
            <el-input v-model="config['vpsproxy']['port']" />
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item
          title="jwt签名"
